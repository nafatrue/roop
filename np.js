function recentPosts(e) {
    if (document.getElementById("recent-posts")) {
        for (var t, s, r = e.feed.entry, n = "", a = document.getElementById("recent-posts"), l = 0; l < numPosts; l++) {
            ...
            var t = r[l].title.$t;
            n += '<li class="most" id="most"><img class="lazyload loaded post-thumb" src="' + u + '" alt="' + t + '"><h2 class="title_post"><a  class="text-reset title_post_anch"href="' + s + '" title="' + t + '">' + t + "</a></h2></li><br/>"
        }
        a.innerHTML = n
    }
}
